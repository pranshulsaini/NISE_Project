...
AT = var5_test; % this defines how each variable can be written in terms of the past three values values of any other variable. So, 3x5x5
nvars = size(AT,1); % number of variables

% Residuals covariance matrix.

SIGT = eye(nvars);   % cov(Y - Y') where Y is true [y1(t), y2(t)..., y1(t)] and Y' contains the predicted values
